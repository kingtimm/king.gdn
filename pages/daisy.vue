<template>
    <div class="grid grid-cols-2 gap-2 md:grid-cols-4"><button class="btn">Default</button> <button
            class="btn btn-primary">Primary</button> <button class="btn btn-secondary">Secondary</button> <button
            class="btn btn-accent">Accent</button> <button class="btn btn-info">Info</button> <button
            class="btn btn-success">Success</button> <button class="btn btn-warning">Warning</button> <button
            class="btn btn-error">Error</button></div>
        ...
        <div class="flex flex-col gap-3 md:flex-row">
            <div class="md:w-1/2">
                ...
                <div class="flex flex-col"><span class="link">I'm a simple link</span> <span class="link link-primary">I'm a
                        simple link</span> <span class="link link-secondary">I'm a
                        simple link</span> <span class="link link-accent">I'm a simple link</span></div>
            </div>
    ...
    <div class="flex flex-col gap-3">
        <div class="flex flex-col gap-3 md:flex-row">
            <div class="md:w-1/2">
                <div><input type="checkbox" class="toggle" checked=""> <input type="checkbox" class="toggle toggle-primary"
                        checked=""> <input type="checkbox" class="toggle toggle-secondary" checked=""> <input
                        type="checkbox" class="toggle toggle-accent" checked=""></div>
                <div><input type="checkbox" class="checkbox" checked=""> <input type="checkbox"
                        class="checkbox checkbox-primary" checked=""> <input type="checkbox"
                        class="checkbox checkbox-secondary" checked=""> <input type="checkbox"
                        class="checkbox checkbox-accent" checked=""></div>
                <div><input type="radio" name="radio-1" class="radio" checked=""> <input type="radio" name="radio-1"
            ...
            <div class="md:w-1/2"><input type="range" min="0" max="100" value="90" class="range range-xs"> <input
                    type="range" min="0" max="100" value="70" class="range range-xs range-primary"> <input type="range"
                    min="0" max="100" value="50" class="range range-xs range-secondary"> <input type="range" min="0"
                    max="100" value="40" class="range range-xs range-accent"></div>
        </div>
        <div class="flex flex-col gap-3 md:flex-row">
